    ...
    <form id="form1" runat="server">
        <div class="pos-f-t">
         ...
         <div class="container-fluid">
                <h1>Informe y Estatus de Liquidaciones</h1>
                <hr class="my-4" />
         </div>    
      <asp:Panel ID="pnlGrid" runat="server" Visible="true">
            <div class="container-fluid">
                <div class="col">
                        ...
                        <Columns>
                            <asp:ButtonField ButtonType="Image" ImageUrl="~/Imagenes/edit.png" Text="Modificar" CommandName="Modificar" HeaderText="Crear PO"> <ControlStyle Height="40px" Width="40px" /><ItemStyle Wrap="False" /> </asp:ButtonField>
                            <asp:ButtonField ButtonType="Image" ImageUrl="~/Imagenes/pdffile.png" Text="Imprimir" CommandName="Imprimir" HeaderText="Imprimir"> <ControlStyle Height="40px" Width="40px" /><ItemStyle Wrap="False" /> </asp:ButtonField>
                            <asp:BoundField DataField="ID" HeaderText="# Liquidacion" />
                            <asp:BoundField DataField="FECHACREACION" HeaderText="Fecha Creacion" />
                            <asp:BoundField DataField="CANTIDAD" HeaderText="Cantidad Motos" DataFormatString="{0:N2}" ItemStyle-HorizontalAlign="Right"/>
                            <asp:BoundField DataField="MONTO" HeaderText="Monto Total" DataFormatString="{0:N2}" ItemStyle-HorizontalAlign="Right"/>
                            <asp:BoundField DataField="USERCODE" HeaderText="Usuario" />
                            <asp:BoundField DataField="BPCODE" HeaderText="Cod Proveedor" />
                            <asp:BoundField DataField="OCSAP" HeaderText="Orden Prov" />
                            <asp:BoundField DataField="FOSAP" HeaderText="Fecha Orden Prov" />
                            <asp:BoundField DataField="FPSAP" HeaderText="Factura Prov." />
                            <asp:BoundField DataField="FFPSAP" HeaderText="Fecha Factura Prov." />
        ...
        <asp:Panel ID="pnlCreatePO" runat="server" Visible="false">
            <center>
                        ...
                        <div class="contenedor">
                                    <div class="row">
                                        <div class="col">
                                            <label for="txtNumeroLiquidacion"># Liquidacion</label>
                                            <asp:TextBox ID="txtNumeroLiquidacion" runat="server" class="form-control" autocoplete="off" readonly="true"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <label for="txtBPCode">Codigo Contratista</label>
                                            <asp:TextBox ID="txtBPCode" runat="server" class="form-control" autocoplete="off" readonly="true"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <label for="txtRefProveedor">Numero Factura Proveedor</label>
                                            <asp:TextBox ID="txtRefProveedor" runat="server" class="form-control" autocoplete="off" ></asp:TextBox>
                                        </div>
                                    </div>
                                    <br />
                                    <div class="row">
                                            <div class="col">
                                            <asp:Button ID="btnCrearPOSAP" runat="server" class="form-control btn btn-primary rounded submit px-3" text="Crear Orden de Compra SAP"/>
                                        </div>
                                    </div>
                                    <br />
                                    <div class="row">
