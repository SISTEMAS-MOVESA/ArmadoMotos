<%@ Page Language="VB" AutoEventWireup="false" CodeFile="VisorSugerido.aspx.vb" Inherits="VisorSugerido" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
            <asp:GridView ID="gridPedidoTemp" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-hover" Width="100%">
                ...
                <Columns>
                    ...
                    <asp:ButtonField ButtonType="Image" ImageUrl="~/Imagenes/edit.png" Text="Editar" CommandName="Editar" HeaderText="Editar" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
        ...
        <div class="d-flex justify-content-around my-3">
            <asp:Button ID="btnReenviarNotificacion" type="button" runat="server" class="btn btn-info mx-3" Text="Reenviar Correo" Width="100%" />
            <asp:Button ID="btnRegresar" runat="server" class="btn btn-dark mx-3" Text="Regresar" Width="100%" />
        </div>
