<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrasladosPiking.aspx.vb" Inherits="TrasladosPiking" %>
...
<script>
    $(document).ready(function () {
        $('#gridDespachosAbiertosMotos').DataTable({
            dom: 'Bfrtip',
            paging: false,
            //scrollY: '300px',
            //scrollCollapse: true,
