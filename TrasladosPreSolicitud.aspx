<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrasladosPreSolicitud.aspx.vb" Inherits="TrasladosPreSolicitud" %>
                            ...
                            <div class="card-body table-responsive p-0" style="height: 100%;">
                                <div class="container-fluid">
                                    <div class="col">
                                        ...
                                        <%--                        <asp:GridView ID="gridPreSolicitudAbierta" runat="server" CssClass="table table-bordered table-hover"  AutoGenerateColumns="false">
                        <HeaderStyle CssClass="thead-dark" />
                          <Columns>
                            <asp:BoundField DataField="ID" HeaderText="Id" />
                            <asp:BoundField DataField="ARTICULO" HeaderText="Articulo" />
