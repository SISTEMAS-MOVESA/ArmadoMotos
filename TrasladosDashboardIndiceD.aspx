<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrasladosDashboardIndiceD.aspx.vb" Inherits="TrasladosDashboardIndiceD" %>
    ...
    <form id="form1" runat="server">
            ...
            <div class="container-fluid">
                ...
                <asp:GridView ID="gridIndiceD" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-hover" Width="100%">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="1~40" HeaderText="Indice 1 al 40" ItemStyle-CssClass="heatmap-cell3" />
                        <asp:BoundField DataField="41~70" HeaderText="Indice 41 al 70" ItemStyle-CssClass="heatmap-cell2" />
        ...
        <script>
            ...
            var colorScale3 = d3.scaleSequential()
                .domain(d3.extent(values3)) // Calcula el rango de valores (mínimo y máximo)
                .interpolator(d3.interpolateOranges); // Gradiente de amarillo a rojo (d3-color-scheme)
