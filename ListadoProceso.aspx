<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ListadoProceso.aspx.vb" Inherits="ListadoProceso" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
            <h1>Motos en Proceso de Armado</h1>
            <hr class="my-4" />
        </div>
        <div class="container-fluid">
            <div class="col">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover" Width="100%">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="DATECREATED" HeaderText="Fecha Solicitud" />
                        ...
                        <asp:BoundField DataField="REPROCESOINICIO" HeaderText="Inicio Reproceso" />
                        <asp:BoundField DataField="OBSERVACIONES3" HeaderText="Estatus" />
