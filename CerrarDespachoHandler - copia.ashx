    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Try
            ...
            Using conn As New SqlConnection(sCon2)
                conn.Open()
                Dim sql As String = " UPDATE [ArmadoMotos].[dbo].[DEPACHOS_HEADER] " &
                                    " SET [ESTADO] = 'CERRADO', [USUARIOMOFICACION] = @usuario, [FECHAMODIFICACION] = GETDATE() WHERE PLANID = @id AND ID = @despachoID; " &
