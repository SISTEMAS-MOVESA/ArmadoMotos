...
Partial Class SupervisoresIndiceGeneral
    Inherits System.Web.UI.Page
    Public Shared sCon1 As String = "server=192.168.1.3;database=MOVESA;uid=sa;password=M*l!n3r0s2k12"
    Public Shared sCon2 As String = "server=192.168.1.3;database=ArmadoMotos;uid=sa;password=M*l!n3r0s2k12"
    Public almacen As String

    Private Sub SupervisoresIndiceGeneral_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
    ...
    Private Sub BindGrid()
        Try
            ...
            Using con As New SqlConnection(constr)
                ...
                Dim SQL_string As String = System.IO.File.ReadAllText(Server.MapPath("~/Querys/planificacion_dashboard_load_sups.sql"))
