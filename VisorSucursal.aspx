<%@ Page Language="VB" AutoEventWireup="false" CodeFile="VisorSucursal.aspx.vb" Inherits="VisorSucursal" %>
                ...
                <div class="d-flex justify-content-center">
                         <asp:GridView ID="gridPedidoTemp" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-hover" Width="100%">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="QTYSUCURSAL" HeaderText="Sucursal" />
                                <asp:BoundField DataField="DIFERENCIA" HeaderText="Diferencia" />
                                <asp:ButtonField ButtonType="Image" ImageUrl="~/Imagenes/edit.png" Text="Editar" CommandName="Editar" HeaderText="Editar"  ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"> <ControlStyle Height="30px" Width="30px" /><ItemStyle Wrap="False" />  </asp:ButtonField>                                
                                <asp:ButtonField ButtonType="Image" ImageUrl="~/Images/delete.png" Text="Eliminar" CommandName="Eliminar" HeaderText="Eliminar"  ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"> <ControlStyle Height="30px" Width="30px" /><ItemStyle Wrap="False" />  </asp:ButtonField>                                
                            </Columns>
                        </asp:GridView>
                    </div>
         <div class="d-flex justify-content-center">
            <div class="col-4">
                <hr />
            <asp:Button ID="btnRegresar" runat="server" class="btn btn-dark" Text="Regresar" Width="100%" Height="100%" />
            </div>
        </div>
...
<script type="text/javascript">
    ...
    }).buttons().container().appendTo('#gridPedidoTemp_wrapper .col-md-6:eq(0)');
