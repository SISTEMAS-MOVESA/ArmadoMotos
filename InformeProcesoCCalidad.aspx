<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InformeProcesoCCalidad.aspx.vb" Inherits="InformeProcesoCCalidad" %>
<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Motos en Proceso</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <%--JUMBOTRON--%>
         <div class="jumbotron">
                <h1 class="display-4">Control de Calidad</h1>
                <hr class="my-4">
                <p class="lead">
        ...
        <asp:Panel ID="pnlGridUsuarios" runat="server" Visible="true">
              <div class="container-fluid">
                      <div class="col">
                            ...
                            <Columns>
                            <asp:ButtonField ButtonType="Image" ImageUrl="~/Imagenes/INICIAR.png" Text="Iniciar" CommandName="Iniciar" HeaderText="Iniciar"> <ControlStyle Height="50px" Width="50px" /><ItemStyle Wrap="False" /> </asp:ButtonField>
                                <asp:BoundField DataField="ID" HeaderText="ID" />
                                <asp:BoundField DataField="SERIE" HeaderText="Serie" />
                                <asp:BoundField DataField="MODELO" HeaderText="Modelo" />
                                <asp:BoundField DataField="COLOR" HeaderText="Color" />
                                <%--<asp:BoundField DataField="DATECREATED" HeaderText="Fecha Asignada" />--%>
                                <%--<asp:BoundField DataField="FIRSTUPDATEDATE" HeaderText="Inicio Armado" />--%>
                                <asp:BoundField DataField="SECONDUPDATEDATE" HeaderText="Fin Armado" />
                                <asp:BoundField DataField="FECHACC1" HeaderText="Fecha Control" />
                                <asp:BoundField DataField="ESTATUS" HeaderText="Estado" />
                                <asp:BoundField DataField="MECANICOASIGNADO" HeaderText="Mecanico" />
                                <asp:ButtonField ButtonType="Image" ImageUrl="~/Imagenes/TERMINAR.png" Text="Terminar" CommandName="Terminar" HeaderText="Terminar" > <ControlStyle Height="50px" Width="50px" /><ItemStyle Wrap="False" /> </asp:ButtonField>
                            </Columns>
                        </asp:GridView>
                </div>
            </div>
