<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrasladosDashboardHero.aspx.vb" Inherits="TrasladosDashboardHero" %>
...
<head runat="server">
    ...
    <title>Indice Desabastecimiento Hero</title>
            ...
            <div class="container-fluid">
                <asp:GridView ID="gridIndiceD" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-hover" Width="100%">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="70" HeaderText="Indice Total" ItemStyle-CssClass="heatmap-cell1" DataFormatString="{0:N2}" />
