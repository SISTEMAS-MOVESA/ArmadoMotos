<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrabajosAd.aspx.vb" Inherits="ModelosMotos" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="pnlGridUsuarios" runat="server" Visible="true">
            <div class="jumbotron">
                <h1 class="display-4">Trabajos Adicionales</h1>
                <hr class="my-4">
                <p class="lead">
                <asp:Button ID="btnIngreso" runat="server" class="btn btn-success rounded" text="Crear Trabajo Adicional" />
                </p>
            </div>   
            ...
            <div class="row">
               <div class="col-12">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-hover" Style="width: 100%">
                        ...
                        <Columns>
                            <asp:ButtonField ButtonType="Image" HeaderText="Modificar" ItemStyle-Width="20px" ImageUrl="~/Imagenes/edit.png" Text="Modificar" CommandName="Modificar"> <ControlStyle Height="18px" Width="18px" /><ItemStyle Wrap="False" /> </asp:ButtonField>
                            <asp:BoundField DataField="ID" HeaderText="ID" />
                            <asp:BoundField DataField="TRABAJO" HeaderText="Descripcion del Trabajo" />
                            <asp:BoundField DataField="PRECIO" HeaderText="Precio Mano de Obra" />
                        ...
                        <div class="contenedor">
                            <div class="wrap">
                                <div class="login-wrap p-4 p-md-5">
                                    <div class="row">
                                        <div class="col">
                                            <label for="txtAddTrabajoAD">Descripcion del Trabajo</label>
                                            <asp:TextBox ID="txtAddTrabajoAD" runat="server" class="form-control" autocoplete="off" ></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <label for="txtAddPrecioTAD">Precio Mano de Obra</label>
                                            <asp:TextBox ID="txtAddPrecioTAD" runat="server" class="form-control" autocoplete="off" ></asp:TextBox>
                                        </div>
                                    </div>
                                    <br />
                                    <div class="row">
                                            <div class="col">
                                            <asp:Button ID="Button1" runat="server" class="form-control btn btn-primary rounded submit px-3" text="Crear Trabajo Adicional"/>
                                        </div>
                                    </div>
                                    <br />
                                    <div class="row">
             ...
             <asp:Panel ID="pnlUpdate" runat="server" Visible="false">
                ...
                <div class="contenedor" >
                    <div class="form-group">
                                    <div class="row">
                                        <div class="col">
                                            <label for="txtUpdateIDTA">ID del Trabajo</label>
                                            <asp:TextBox ID="txtUpdateIDTA" runat="server" class="form-control" ReadOnly="true" ></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <label for="txtUpdateDescripcionTA">Descripcion del Trabajo</label>
                                            <asp:TextBox ID="txtUpdateDescripcionTA" runat="server" class="form-control" ></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <label for="txtUpdatePrecioTA">Precio Trabajo Adicional</label>
                                            <asp:TextBox ID="txtUpdatePrecioTA" runat="server" class="form-control" autocoplete="off" ></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <label for="txtUpdateStatus">Estatus</label>
                                            <br />
                                            <asp:DropDownList ID="drpEstatus" runat="server" class="btn btn-secondary dropdown-toggle; text-left" >
                                                <asp:ListItem Selected="True" Value="1">Activo</asp:ListItem>
                                                <asp:ListItem Value="0">Inactivo</asp:ListItem>
                                            </asp:DropDownList>
                                            <%--<asp:TextBox ID="txtUpdateStatus" runat="server" class="form-control" autocoplete="off"></asp:TextBox>--%>
                                        </div>
                                    </div>
                        <br />
                        <div class="row">
