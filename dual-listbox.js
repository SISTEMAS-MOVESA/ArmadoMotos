                        ...
                        l(e, [
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    t > -1 &&
                                        (this.available.splice(t, 1),
                                            this.selected.push(e),
                                            this._selectOption(e.dataset.id),
                                            this._reindexSelectedItems(),
                                            this.redraw());
                                },
                            },
                            {
                            ...
                            {
                                key: "_reindexSelectedItems",
                                value: function () {
                                    for (var e = 0; e < this.selected.length; e++)
                                        this.selected[e].dataset.order = e + 1;
                                },
                            },
                            {
                                key: "searchLists",
                                value: function (e, t) {
                                    for (
                                        ...
                                        var n = i[l];
                                        e && n.textContent.toLowerCase().indexOf(s) === -1
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    for (e.preventDefault(); this.available.length > 0;)
                            ...
                            },
                            {
                                ...
                                value: function (e, t) {
                                    ...
                                    i && i.preventDefault();
                                    for (
                                        var s = t.querySelectorAll("." + u), l = 0;
                                        l < s.length;
                                        l++
                                    ) {
                                        var n = s[l];
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    var t = this;
                                    return (
                                        e.addEventListener("dblclick", function (i) {
                                ...
                                value: function (e) {
                                    for (var t = e.options, i = 0; i < t.length; i++) {
                                        ...
                                        s.attributes.selected
                                            ? ((l.dataset.order = this.selected.length + 1),
...
//                  t > -1 &&
//                    (this.available.splice(t, 1),
//                    (e.dataset.order = this.currentOrder++),
//                    this.selected.push(e),
//                    this._selectOption(e.dataset.id),
//                    this.redraw());
//                },
...
//                    this.available.push(e),
//                    this._deselectOption(e.dataset.id),
//                    this.selected.length === 0 && (this.currentOrder = 1),
//                    this.redraw());
//                },
//              },
//              {
...
//                      l = this._createListItem(s);
//                    s.attributes.selected
//                      ? ((l.dataset.order = this.currentOrder++),
//                        this.selected.push(l))
//                      : this.available.push(l);
//                  }
//                },
