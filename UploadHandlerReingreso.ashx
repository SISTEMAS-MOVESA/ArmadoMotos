<%@ WebHandler Language="VB" Class="UploadHandlerReingreso" %>

Imports System.Web
Imports System.IO

Public Class UploadHandlerReingreso : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Try
            If context.Request.Files.Count > 0 Then
                ...
                Dim savePath As String = context.Server.MapPath("~/Imagenes/Auditoria/Reingreso/") & fileName
