<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InformeCC.aspx.vb" Inherits="InformeCC" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    <title>Motos Control Calidad Terminado</title>
...
<body>
    <form id="form1" runat="server" style="overflow-y:scroll;">
        ...
        <div class="grid-container">
            <h1 class="text-center">Motos Control Calidad Terminado</h1>
            <style>
                .box {
                    display: flex;
                    align-items: stretch;
