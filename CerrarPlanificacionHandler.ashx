<%@ WebHandler Language="VB" Class="CerrarPlanificacionHandler" %>
...
Public Class CerrarPlanificacionHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Try
            ...
            Using conn As New SqlConnection(sCon2)
                conn.Open()
                Dim sql As String = "UPDATE [ArmadoMotos].[dbo].[PLANIFICACIONES] " &
                                    "SET [ESTADO] = 'CERRADO', [USUARIOACTUALIZACION] = @usuario, [FECHAACTUALIZACION] = GETDATE() " &
                                    "WHERE id = @id"
