    ...
    Private Sub BindGrid()
        Try
            ...
            Using con As New SqlConnection(constr)
                ...
                Dim SQL_string As String = System.IO.File.ReadAllText(Server.MapPath("~/Querys/InformeCC_BindGrid_Proceso_Calidad_Finalizado.sql"))
    ...
    Private Sub GridView1_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GridView1.RowCommand
        Try
            If e.CommandName = "Iniciar" Then
                ...
                UpdateInicioCalidad(Date.Now, GridView1.Rows(index).Cells(2).Text)
                'Session("SerieCalidad") = GridView1.Rows(index).Cells(2).Text
