<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AuditoriaInformeCobros.aspx.vb" Inherits="AuditoriaInformeCobros" %>
        ...
        <div class="container-fluid" style="flex:auto; justify-content:center;">
            ...
            <div class="row my-3">
                ...
                <div class="col-3">
                    ...
                    <asp:Button ID="btnReset" runat="server" CssClass="btn btn-info justify-content-center align-content-center" Text="Reset" Width="100%" />
                </div>
            </div>
            <div class="row my-3">
