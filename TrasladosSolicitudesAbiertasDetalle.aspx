<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrasladosSolicitudesAbiertasDetalle.aspx.vb" Inherits="TrasladosSolicitudesAbiertasDetalle" %>
                ...
                <div class="container-fluid">
                    <div class="col">
                        <asp:GridView ID="gridCuadroBasico" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-hover" Width="100%">
                            ...
                            <Columns>
                                <asp:BoundField DataField="WHSCODE" HeaderText="Id" />
                                <asp:BoundField DataField="WHSNAME" HeaderText="Header Id" />
                                <asp:BoundField DataField="CODIGOCLIENTE" HeaderText="Articulo" />
                                <asp:BoundField DataField="ITEMCODE" HeaderText="Modelo" />
                                <asp:BoundField DataField="MODELO" HeaderText="Descripcion" ItemStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="DESCRIPCION" HeaderText="Cantidad" />
                                <asp:BoundField DataField="QTYSOLICITADA" HeaderText="Espacios" />
                                <asp:BoundField DataField="QTYPREPARADA" HeaderText="Estado" />
                                <asp:BoundField DataField="CAMION" HeaderText="Destino" />
                                <asp:BoundField DataField="PREIDHEADER" HeaderText="Ruta" />
                                <asp:BoundField DataField="MACROID" HeaderText="Macro ID" />
