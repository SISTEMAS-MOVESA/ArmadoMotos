<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InformeCCFinArmado.aspx.vb" Inherits="InformeCCFinArmado" %>
...
<head runat="server">
    ...
    <title>Motos Pendientes Control Calidad</title>
...
<body>
    <form id="form1" runat="server" style="overflow-y:scroll;">
            ...
            <div class="container-fluid" style="overflow-x: scroll;overflow-y:scroll;">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="SECONDUPDATEDATE" HeaderText="Armado" />
        ...
        <div class="ui flyout" id="IniciarPintura">
            ...
            <div class="ui header">
                <div class="content">
                    <h1>Seleccione Auditor de Control de Calidad</h1>
                    <div class="row">
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <label for="txtFlyMiniModelo">Modelo</label>
                            <asp:TextBox ID="txtFlyMiniModelo" runat="server" Text="" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                        </div>
                        <div class="col-12">
                            <label for="txtFlyMiniColor">Color</label>
                            <asp:TextBox ID="txtFlyMiniColor" runat="server" Text="" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                        </div>
                        <div class="col-12">
                            <label for="txtFlyMiniMecanico">Mecanico</label>
                            <asp:TextBox ID="txtFlyMiniMecanico" runat="server" Text="" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <label for="drpCalidadUsers">Seleccione Auditor</label>
                            <asp:DropDownList ID="drpCalidadUsers" runat="server" class="btn btn-secondary dropdown-toggle; text-left" Width="100%"></asp:DropDownList>
                        </div>
                    </div>
                </div>
            </div>
            <div class="actions">
                ...
                <asp:Button ID="btnInicioCCalidad" runat="server" class="ui green button" Text="Proceder Auditoria" />
            </div>
        </div>
        <center>
...
<link href="https://cdn.datatables.net/responsive/3.0.3/css/responsive.bootstrap.css" rel="stylesheet" type="text/css" />
