<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrasladosPreparar.aspx.vb" Inherits="TrasladosPreparar" %>
        ...
        <div class="d-flex justify-content-center">
                <asp:GridView ID="gridCargaCamion" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-hover" Width="100%">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="FechaPrep" HeaderText="Fecha Preparacion"/>
                        <asp:BoundField DataField="WHSCODE" HeaderText="Cod. Almacen" />
                        <asp:BoundField DataField="WHSNAME" HeaderText="Nombre Almacen" ItemStyle-HorizontalAlign="Left" />
                        <asp:BoundField DataField="Supervisor" HeaderText="Supervisor" />
                        <asp:BoundField DataField="Total" HeaderText="Total Motos" ItemStyle-HorizontalAlign="Left" />
                        <asp:ButtonField ButtonType="Image" ImageUrl="~/images/5098814.png" Text="Editar" CommandName="Series" HeaderText="Series" 
                            ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"> <ControlStyle Height="25px" Width="25px" />
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#gridCargaCamion thead tr')
            .clone(true)
            .addClass('filters')
            .appendTo('#gridCargaCamion thead');

        var table = $('#gridCargaCamion').DataTable({
            orderCellsTop: true,
            fixedHeader: true,
            order: [[0, 'desc']],
            dom: 'Bfrtip',
