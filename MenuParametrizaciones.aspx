<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MenuParametrizaciones.aspx.vb" Inherits="MenuParametrizaciones" %>
            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-gradient-gray-dark">
                        <div class="inner">
                            <h3>
                                <asp:Label ID="lblContratistas" runat="server" Text="0"></asp:Label>
                                /
                                <asp:Label ID="lblMecanicos" runat="server" Text="0"></asp:Label></h3>
                            <p>Contratistas / Mecanicos</p>
                        </div>
                        <div class="icon">
                            <i class="ion-person-stalker"></i>
                        </div>
                        <a href="Contratistas.aspx" class="small-box-footer">Ingresar <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-gradient-gray-dark">
                        <div class="inner">
                            <h3>
                                <asp:Label ID="lblCantTrabajosAD" runat="server" Text="0"></asp:Label></h3>
                            <p>Trabajos Adicionales</p>
                        </div>
                        <div class="icon">
                            <i class="ion-speedometer"></i>
                        </div>
                        <a href="TrabajosAd.aspx" class="small-box-footer">Ingresar <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-gradient-gray-dark">
                        <div class="inner">
                            <h3>
                                <asp:Label ID="lblModeloPrecio" runat="server" Text="0"></asp:Label></h3>
                            <p>Precios de Armado</p>
                        </div>
                        <div class="icon">
                            <i class="ion-cash"></i>
                        </div>
                        <a href="PrecioModelos.aspx" class="small-box-footer">Ingresar <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-gradient-gray-dark ">
                        <div class="inner">
                            <h3>
                                <asp:Label ID="lblCantUsuarios" runat="server" Text="0"></asp:Label></h3>
                            <p>Usuarios</p>
                        </div>
                        <div class="icon">
                            <i class="ion-man"></i>
                        </div>
                        <a href="Usuarios.aspx" class="small-box-footer">Ingresar <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-gradient-blue">
                        <div class="inner">
                            <h3>*</h3>
                            <p>Crear Articulos SAP</p>
                        </div>
                        <div class="icon">
                            <i class="ion-person-stalker"></i>
                        </div>
                        <a href="SapNewItems.aspx" class="small-box-footer">Ingresar <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-gradient-blue">
                        <div class="inner">
                            <h3>*</h3>
                            <p>Ordenamiento y Promociones</p>
                        </div>
                        <div class="icon">
                            <i class="ion-person-stalker"></i>
                        </div>
                        <a href="Ordenamiento.aspx" class="small-box-footer">Ingresar <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-gradient-gray-dark">
                        <div class="inner">
                            <h3>*</h3>
                            <p>Ubicaciones Motos</p>
                        </div>
                        <div class="icon">
                        </div>
                        <a href="UbicacionesMotos.aspx" class="small-box-footer">Ingresar <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
