<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrasladosCrearSolicitudTS.aspx.vb" Inherits="TrasladosCrearSolicitudTS" %>
...
<body>
    <form id="form1" runat="server">
                ...
                <div class="six wide column">
                    <div class="card-body table-responsive p-0" style="height: 100%;">
                        <div class="container-fluid">
                            <h3>Documentos a Crear</h3>
                            <asp:GridView ID="gridPresolicitudes" runat="server" CssClass="table table-bordered table-hover" AutoGenerateColumns="false">
                                <HeaderStyle CssClass="thead-dark" />
                                <Columns>
                                    <asp:BoundField DataField="WHSCODE" HeaderText="Cod. Almacen Destino" />
                                    <asp:BoundField DataField="WHSNAME" HeaderText="Almacen Destino" />
        ...
        <div class="row">
            <div class="col">
                <asp:Button ID="btnCrearCamion" runat="server" class="btn btn-success btn-block" Text="Crear Camion" UseSubmitBehavior="False" />
            </div>
        </div>
