...
Partial Class CreateCustomer
    ...
    Public Sub _CargarGrupoCliente()
        ...
        Catch ex As Exception
            ADD_LOG("_CargarGrupoCliente", ex.Message)
        End Try
    End Sub
    ...
    Public Sub _CargarVendedores()
        ...
        Catch ex As Exception
            ADD_LOG("_CargarVendedores", ex.Message)
        End Try
    End Sub
    ...
    Public Sub _CargarDepartamento()
        ...
        Catch ex As Exception
            ADD_LOG("_CargarDepartamento", ex.Message)
        End Try
    End Sub
    ...
    Public Sub _CargarMunicipio(_CodeDepto As String)
        ...
        Catch ex As Exception
            ADD_LOG("_CargarMunicipio", ex.Message)
        End Try
    End Sub
    ...
    Public Sub _CargarSucursal()
        ...
        Catch ex As Exception
            ADD_LOG("_CargarSucursal", ex.Message)
        End Try
    End Sub
    ...
    Public Sub login_sp()
        Try
            ...
            If lRetCode <> 0 Then
                ...
                ADD_LOG("login_sp", xCompany.GetLastErrorDescription)
            End If
        Catch ex As Exception
            ADD_LOG("login_sp", ex.Message)
        End Try
    End Sub

    Private Sub CreateCustomer_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
            'GESTORC
            ...
            End If
        Catch ex As Exception
            ADD_LOG("CreateCustomer_Load", ex.Message)
        End Try
    End Sub
