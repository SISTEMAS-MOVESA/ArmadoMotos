<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MenuDacion.aspx.vb" Inherits="MenuDacion" %>
					...
					<div class="wrap">
						<div class="login-wrap p-4 p-md-5">
                              ...
                              <div class="row align-items-center">
                                <div class="col">
                                    <label for="ImageButton1">Orden de Recuperacion</label>
                                    <br />
                                    <asp:ImageButton ID="ImageButton1" runat="server" Height="80px" Width="80px" ImageUrl="~/Imagenes/Dacion01.gif" ToolTip="Orden de Recuperacion" />                                   </div>
                                <div class="col">
                                    <label for="ImageButton2">Confirmacion Recuperacion</label>
                                    <br />
                                    <asp:ImageButton ID="ImageButton2" runat="server" Height="80px" Width="80px" ImageUrl="~/Imagenes/Dacion02.gif" ToolTip="Confirmacion Recuperacion" />
                                </div>
                                <div class="col">
                                    <label for="ImageButton3">Confirmacion Venta</label>
                                    <br />
                                    <asp:ImageButton ID="ImageButton3" runat="server" Height="80px" Width="80px" ImageUrl="~/Imagenes/Dacion03.gif" ToolTip="Confirmacion Venta" />
                                </div>
                                <div class="col">
                                    <label for="ImageButton1">Actualizacion Precios</label>
                                    <br />
                                    <asp:ImageButton ID="ImageButton4" runat="server" Height="80px" Width="80px" ImageUrl="~/Imagenes/Dacion04.gif" ToolTip="Actualizacion Precios" />                                   </div>
                                <div class="col">
                                    <label for="ImageButton2">Reconciliaciones</label>
                                    <br />
                                    <asp:ImageButton ID="ImageButton5" runat="server" Height="80px" Width="80px" ImageUrl="~/Imagenes/Dacion05.gif" ToolTip="Reconciliaciones" />
                                </div>
                              </div>
