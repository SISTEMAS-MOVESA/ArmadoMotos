...
,(select AUDITORCCASIGNADO from ArmadoMotos..ARMADOMOTOS where SERIe=t0.SERIE)[AUDITORCCASIGNADO]
From [dbo].[ARMADOMOTOS] t0 With(nolock) where ESTATUS in ('Calidad Procesando')  and CANCELED='N' and LIQUIDACIONID=0 
