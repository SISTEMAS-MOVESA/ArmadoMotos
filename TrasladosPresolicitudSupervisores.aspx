<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrasladosPresolicitudSupervisores.aspx.vb" Inherits="TrasladosPresolicitudSupervisores" %>
                ...
                <div class="row">
                    ...
                    <section class="col-lg-12 connectedSortable">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">Motivo Traslado</div>
                                    <div class="col">Fecha Deseada</div>
                                    <div class="col">Estado Cliente</div>
                                    <div class="col">Limite Credito</div>
                                    <div class="col">Saldo a la Fecha</div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <asp:TextBox ID="txtNalmacenOrigen" runat="server" CssClass="form-control" Width="100%" Text="Distribucion Central de Motos" ReadOnly="true"></asp:TextBox>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-2">
                                        <asp:Button ID="btnCrearSolicitud" name="btnCrearSolicitud" runat="server" class="btn btn-success btn-block" Text="Agregar Moto" UseSubmitBehavior="False" />
                                    </div>
                                    <div class="col-3">
                                        ...
                                        <asp:GridView ID="gridPreSolicitudAbierta" runat="server" CssClass="table table-bordered table-hover"
                                            ...
                                            <Columns>
                                                ...
                                                <%--<asp:TemplateField HeaderText="Eliminar" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        <button type="button" onclick='<%# "mostrarToast(" + Eval("ID").ToString() + ")" %>'>
                                                            <img src="~/Images/delete.png" alt="Eliminar" height="30" width="30" />
                                                        </button>
                                                    </ItemTemplate>
                                                </asp:TemplateField>--%>
                                        ...
                                        <%--<script>
                                            ...
                                            function eliminarLinea(idLinea) {
                                                ...
                                                var ajaxRequest = $.ajax({
                                                    url: 'TrasladosPreSolicitudSucursal.aspx/EliminarLinea',
                                                    type: 'POST',
                                                ...
                                                ajaxRequest.done(function (response) {
                                                    // Llamar a la función para obtener las solicitudes abiertas al cargar la página
                                                    //location.reload();
                                                    //if (response.success) {
                                                    //    // The line was successfully deleted
                                                    //    alert('La línea fue eliminada correctamente');
                                                    //} else {
                                                    //    // An error occurred
                                                    //    alert('Se produjo un error al eliminar la línea 0');
                                                    //}
                                                });

                                                // Handle the error callback
                                                ajaxRequest.fail(function (error) {
                                                    alert('Se produjo un error al eliminar la línea: ' + error.message);
                                                });
                                            }
                                        </script>--%>
                                    </div>
...
<script>
    $(document).ready(function () {
        ...
        if (x == 'BLOQUEADO') {
            ...
            $("#btnCrearCamion").prop("disabled", true);
