            ...
            <form id="form1" runat="server">
                ...
                <div class="container" style="max-width: 900px; padding: 20px;">
                    ...
                    <div class="row mb-3 justify-content-center align-items-center">
                        ...
                        <div class="col-3">
                            <input name="txtFechaCamion" type="datetime-local" id="txtFechaCamion" class="form-control">
                            <!-- <asp:TextBox ID="txtFechaCamion" runat="server" CssClass="form-control" TextMode="Date">
                            </asp:TextBox> -->
                        </div>
                        <div class="col-3">
                            Seleccione Placa
