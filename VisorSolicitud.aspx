<%@ Page Language="VB" AutoEventWireup="false" CodeFile="VisorSolicitud.aspx.vb" Inherits="VisorSolicitud" %>
 ...
 <div class="d-flex justify-content-center">
        ...
        <div class="d-flex justify-content-center">
            ...
            <asp:GridView ID="gridPedidoTemp" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-hover" Width="100%">
                ...
                <Columns>
                    <asp:BoundField DataField="Filler" HeaderText="Alm. Origen" />
                    <asp:BoundField DataField="ToWhsCode" HeaderText="Codigo Almacen" />
                    <asp:BoundField DataField="Almacen" HeaderText="Nombre Almacen" />
                    <asp:BoundField DataField="ItemCode" HeaderText="Codigo" />
                    <asp:BoundField DataField="Dscription" HeaderText="Descripcion" />
                    <asp:BoundField DataField="U_MSERIE" HeaderText="Serie Moto" />
