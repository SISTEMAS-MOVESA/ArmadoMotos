<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrasladosPresolicitudesAbiertas.aspx.vb" Inherits="TrasladosPresolicitudesAbiertas" %>
...
<head runat="server">
    ...
    <title>Pre Solicitudes Abiertas</title>
                    ...
                    <div class="col">
                        <asp:GridView ID="gridCuadroBasico" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-hover" Width="100%">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="DATECREATED" HeaderText="FECHA CREACION" />
                                <asp:BoundField DataField="ALMORIGEN" HeaderText="ORIGEN" />
                                <asp:BoundField DataField="ALMDESTINO" HeaderText="DESTINO" />
                                <asp:BoundField DataField="NALMACEN" HeaderText="Nombre Alnacen" ItemStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="CODCLIALMDESTINO" HeaderText="Codigo Cliente" />
                                <asp:BoundField DataField="OBSERACIONES" HeaderText="Observaciones" />
                                <asp:BoundField DataField="CAMION" HeaderText="MACRO ID" />
