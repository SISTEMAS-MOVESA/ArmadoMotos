<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MenuProcesoCotable.aspx.vb" Inherits="MenuProcesoCotable" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Menu Proceso Contable</title>
    ...
    <div class="container-fluid">
          ...
          <div class="col-lg-4 col-6">
            <div class="small-box bg-gradient-cyan">
              <div class="inner">
                <h3><asp:Label ID="lblContratistas" runat="server" Text="*"></asp:Label> </h3>
                <p>Liquidaciones</p>
              </div>
              <div class="icon">
                <i class="ion-person-stalker"></i>
              </div>
              <a href="ProcesoContable.aspx" class="small-box-footer">Ingresar <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <div class="col-lg-4 col-6">
            <div class="small-box bg-gradient-olive">
              <div class="inner">
                <h3><asp:Label ID="lblModeloPrecio" runat="server" Text="*"></asp:Label></h3>
                <p>Ordenes de Compra</p>
              </div>
              <div class="icon">
                <i class="ion-cash"></i>
              </div>
              <a href="GenerarPO.aspx" class="small-box-footer">Ingresar <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <div class="col-lg-4 col-6">
            <div class="small-box bg-gradient-purple">
              <div class="inner">
                <h3><asp:Label ID="lblCantUsuarios" runat="server" Text="*"></asp:Label></h3>
                <p>Consultas / Historico de Liquidaciones</p>
              </div>
              <div class="icon">
                <i class="ion-man"></i>
              </div>
              <a href="ProcesoContableConsulta.aspx" class="small-box-footer">Ingresar <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
        </div>
