...
Partial Class TrasladosPresolicitudesAbiertasDetalle
    Inherits System.Web.UI.Page
    Public Shared sCon1 As String = "server=192.168.1.3;database=MOVESA;uid=sa;password=M*l!n3r0s2k12"
    Public Shared sCon2 As String = "server=192.168.1.3;database=ArmadoMotos;uid=sa;password=M*l!n3r0s2k12"
    Public MyTable As New DataTable

    Private Sub TrasladosPresolicitudesAbiertasDetalle_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
    ...
    Private Sub BindGrid(_id As String)
        Try
            ...
            Using con As New SqlConnection(constr)
                Dim SQL_STRING As String = "SELECT * FROM [ArmadoMotos].[dbo].[PRESOLICITUD_LINES] WHERE HEADERID=" & _id & ""
    ...
    Private Sub btnRegresar_Click(sender As Object, e As EventArgs) Handles btnRegresar.Click
        Try
            Response.Redirect("TrasladosPresolicitudesAbiertas.aspx")
        Catch ex As Exception
