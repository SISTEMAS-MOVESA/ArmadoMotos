...
Partial Class SupervisoresDetalleDespacho
    Inherits System.Web.UI.Page
    Public Shared sCon1 As String = "server=192.168.1.3;database=MOVESA;uid=sa;password=M*l!n3r0s2k12"
    Public Shared sCon2 As String = "server=192.168.1.3;database=ArmadoMotos;uid=sa;password=M*l!n3r0s2k12"
    Public almacen As String

    Private Sub SupervisoresDetalleDespacho_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
            If IsPostBack = False Then
                If Session("Name") Is vbNullString Then
                    Response.Redirect("Default.aspx")
                Else
                    BindGridDespachosAbiertos(Request.QueryString("despachoId"))
        ...
        End Try
    End Sub
    Private Sub BindGridDespachosAbiertos(despachoId As String)
        Try
