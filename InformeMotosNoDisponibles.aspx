<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InformeMotosNoDisponibles.aspx.vb" Inherits="InformeMotosNoDisponibles" EnableEventValidation="false" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Motos No Disponibles</title>
...
<body>
    <form id="form1" runat="server">
        <div class="pos-f-t">
          ...
          <%--JUMBOTRON--%>
         <div class="jumbotron">
                <h1 class="display-4">Motos No Disponibles</h1> 
                <%--<a href="#" class="badge badge-success">Motos Listas Para Armar</a>--%>

                <hr class="my-4">
                <p class="lead">
                    <asp:Button ID="btnIngreso" runat="server" class="btn btn-success rounded" text="Exportar a Excel"/>
                    <asp:Button ID="btnFiltrar" runat="server" class="btn btn-success rounded" text="Filtrar Motos Listas Para Armado Completo"/>
                </p>
         </div>  
            <asp:Panel ID="pnlGridControlCalidad" runat="server" Visible="true">
                <div class="container-fluid">
                    <div class="col">
                            ...
                            <Columns>
                            <asp:ButtonField ButtonType="Image" ImageUrl="~/Imagenes/find2.png" Text="Expediente" CommandName="Expediente" HeaderText="Expediente"> <ControlStyle Height="50px" Width="50px" /><ItemStyle Wrap="False" /> </asp:ButtonField>
         ...
         <asp:Panel ID="pnlMotosListasParaArmado" runat="server" Visible="false">
                <div class="container-fluid">
                    <div class="col">
                             <asp:GridView ID="GridMotosListasParaArmar" runat="server" CssClass="display compact" AutoGenerateColumns="false">
                            <Columns>
                            <asp:ButtonField ButtonType="Image" ImageUrl="~/Imagenes/find2.png" Text="Expediente" CommandName="Expediente" HeaderText="Expediente"> <ControlStyle Height="50px" Width="50px" /><ItemStyle Wrap="False" /> </asp:ButtonField>
                                <asp:BoundField DataField="SerieOrigen" HeaderText="Serie" />
                            <asp:ButtonField ButtonType="Image" ImageUrl="~/Imagenes/edit.png" Text="CrearOrden" CommandName="CrearOrden" HeaderText="Crear Orden"> <ControlStyle Height="50px" Width="50px" /><ItemStyle Wrap="False" /> </asp:ButtonField>
                            </Columns>
                        </asp:GridView>
                        </div>
                    </div>
             <br />
                    <asp:Button ID="btnRegresar" runat="server" class="btn btn-success rounded" text="Regresar"/>
...
<script type="text/javascript">
    $(function () {
        ...
        $("[id*=GridMotosListasParaArmar]").DataTable(
       {
           bLengthChange: true,
           lengthMenu: [[10, -1], [10, "All"]],
           order: [[1, "desc"]],
