<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SupervisoresCalendarioDespachos.aspx.vb" Inherits="SupervisoresCalendarioDespachos" %>
                  ...
                  document.addEventListener('DOMContentLoaded', function () {
                      ...
                      const calendar = new FullCalendar.Calendar(calendarEl, {
                          ...
                          events: function (info, successCallback, failureCallback) {
                              fetch('SupervisoresCalendarioDespachos.aspx/ObtenerEventos', {
                                  method: 'POST',
                                  headers: {
                          ...
                          eventContent: function (arg) {
                              const despachoID = arg.event.extendedProps.DespachoID;
                              const title = arg.event.title;

                              const linkEl = document.createElement('a');
                              linkEl.href = 'SupervisoresDetalleDespacho.aspx?despachoId=' + encodeURIComponent(despachoID);
                              linkEl.target = '_blank';                          // <- abrir en nueva pestaña
                              linkEl.rel = 'noopener noreferrer';                // <- evita tabnabbing
